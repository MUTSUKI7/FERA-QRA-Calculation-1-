...
@st.cache_data(show_spinner=False)
def compute_lsir_field(_excel_bytes, grid_extent_x_m, grid_extent_y_m, grid_res_m, back_frac, cross_frac):
    ...
    with st.spinner("LSIR 계산 중..."):
        try:
            X, Y, risk_field, is_coords = compute_lsir_field(
                excel_bytes, grid_extent_x_m, grid_extent_y_m, grid_res_m, back_frac, cross_frac
            )
        except Exception as e:
